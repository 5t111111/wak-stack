...
import { authorDetailQuery } from "./queries/author-detail.query.server";
import { authorListQuery } from "./queries/author-list.query.server";
import { getPostsByAuthorQuery } from "./queries/get-posts-by-author.query.server";
